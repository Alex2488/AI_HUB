            ...
            <div class="table_wrap border_bottom mb-50">
                <table class="table m-0">
                    ...
                    <tr>
                        ...
                        <th class="text-center">Рядок URL</th>
                    ...
                    @foreach ($categories as $category)
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <span class="text-center"> 0 {{--{{$category -> email}}--}}</span>
                            </td>
                           ...
                           {{-- <td class="text-center">
                                ...
                                <a href="{{route('edit-user', $category)}}" type="button" class="edit">
                                    <i class="fas fa-edit icon_blue"></i>
                                </a>
                            </td>
                            <td class="text-center">

                                <form method="POST" action="{{ route('delete-user', $category->id) }}">
                                    @csrf
                                    <input name="_method" type="hidden" value="DELETE">
                                    <a type="submit" class="delete show_confirm"
                                       data-title-service="{{$category->name}}"><i
