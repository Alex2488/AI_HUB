                ...
                <div class="col-lg-8 col-md-8 col-sm-10">
                    <div class="contact_form" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <div class="section_title decrease_size mb-50">
                            <h2 class="title_text mb-30">Редагувати сервіс {{$dataService->title}} </h2>
                        ...
                        {{--<form action="{{url('/')}}/panel/edit-service/{{$dataService->slug}}/update-service" method="post">--}}
                        <form action="{{ route('update-service', $dataService->id )}}" method="post">
