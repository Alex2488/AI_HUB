            ...
            <div class="jobs_grid element_grid position-relative">
                ...
                @endif
                    ...
                    @if ($favoriteServices->count() === 0)
                        <p class="text-center" data-aos="fade-up" data-aos-delay="100">Відсутні улюблені сервіси</p>
                    @endif

                @foreach($favoriteServices as $favoriteService)
                    @foreach($services as $service)

                        @if($service->id === $favoriteService->service_id)
